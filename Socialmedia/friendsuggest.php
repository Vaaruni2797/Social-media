...
<li class=""><a href="#suggestions" style="color: white" title="friend suggestions"><i class="fa fa-2x fa-user-plus"></i></a></li>
...
<div class="container-fluid" id="suggestions" align="center" style="padding-top: 50px">
<?php
while ($row = mysqli_fetch_assoc($result1))
{
echo '<a href="notfriendprofile.php?id='.$row['username'].'"><h2>'. $row['username'] . '</h2></a>';
echo '<a href="requestvaar.php?id='.$row['username'].'"><h5>'. 'Send request' . '</h5></a>';
