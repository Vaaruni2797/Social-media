...
<p style="color: white">one more thing left</p>
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalHobbies">click me</button></div>
...
<form class="form-horizontal" role="form"  method="post" action="hobby.php"  name="details" >
<div class="form-group">
<label class="user">What are your hobbies?</label>
<input type="text" class="form-control" required name="hob" placeholder="Hobbies">
</div>
<div class="form-group">
<label class="user">Tell us something interesting about you, this will go in your bio.</label>
