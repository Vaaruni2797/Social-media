...
include('config.php');
$user= $_COOKIE['user'];
$result = mysqli_query($db,"SELECT * FROM friends WHERE friend_two ='$user' AND status = '0'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<li class=""><a href="#requests"style="color: white" title="requests"><i class="fa fa-2x fa-clock-o"></i></a></li>
...
<div class="container-fluid" id="requests" align="center" style="padding-top: 50px">
<?php
while ($row = mysqli_fetch_array($result))
{
if($row['status'] == '0'){
echo '<a href="notfriendprofile.php?id='.$row['friend_one'].'"><h2>'. $row['friend_one'] . '</h2></a>';
echo '<a href="accept.php?id='.$row['friend_one'].'"><h5>'. 'Accept' . '</h5></a>';
echo '<a href="decline.php?id='.$row['friend_one'].'"><h5>'. 'Decline' . '</h5></a>';
echo '<hr>';
}
}
?>
