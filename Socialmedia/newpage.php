...
<form class="form-horizontal" role="form"  method="post" action="info.php"  name="details" >
<div class="form-group">
<label class="user">Tell us your facebook ID</label>
<input type="text" class="form-control"  name="fbid" placeholder="facebook ID" >
</div>
<div class="form-group">
<label class="user">Tell us your Instagram ID</label>
<input type="text" class="form-control"  name="instaid" placeholder="Instagram ID" >
</div>
<div class="form-group">
